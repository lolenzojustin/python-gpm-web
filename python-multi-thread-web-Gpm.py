...
class MultiThread(QThread):
    ...
    def __init__(self, index, soluong, domain, password, month, proxy, apiurl, kichthuocmanhinh, api_captra):
        super().__init__()
        self.index = index
    ...
    def CreateAcc(self):
        ...
        try:
            ...
            print("id_profile là", self.id_profile)

            # Bước 2: tạo profile GPM xong
            self.record.emit(self.index, self.proxy, random_email, password_nhap, text_month, "Đã tạo profile GPM")
